...
int main() {
    ...
    char foo[] = {
            ...
            0xff,0xff,0x02,0x0a,0x0a,0x0a,0x0a,0xff,0xff,0x0a,0x0a,0x0a,0x0a,0x0a,0xff,0xff,
            0xff,0x02,0x02,0x09,0x09,0x09,0x09,0xff,0xff,0x09,0x09,0x09,0x09,0x09,0x09,0xff,
            0xff,0x02,0x02,0x08,0x08,0x08,0xff,0xff,0xff,0xff,0x08,0x08,0x08,0x08,0x08,0xff,
            0xff,0x02,0x02,0x07,0x07,0x07,0x02,0x02,0x02,0x02,0x07,0x07,0x07,0x07,0x07,0xff,
            0xff,0x02,0x02,0x06,0x06,0x06,0x06,0x06,0x06,0x06,0x06,0x06,0x06,0x06,0x06,0xff,
            0xff,0x02,0x02,0x05,0x05,0x05,0x05,0x02,0x02,0x05,0x05,0x05,0x05,0x05,0x05,0xff,
            0xff,0xff,0x02,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0x04,0xff,0xff,
    ...
    for (int i = 0; i < SPRITESIZE; i++) {
        ...
        n->bitmap[1][i] = bitmap;
        n->mask[1][i] = mask;
        n->bitmap[0][i] = (bitmap >> 4) | 0xf000000000000000;
        n->mask[0][i] = (mask >> 4) | 0xf000000000000000;
    }
    n->bgValid = false;
    sprites[1] = n;
    ...
    drawSprite(100,100,1, false);
    drawSprite(101,116,1, false);
}
