...
#endif
{
    ...
    vgaFillScreen(BLACK);
    setTextColor(RED);
    printString("\x1b[Z22;10;10;500;5Z");
    setTextColor(BLUE);
    printString("\x1b[Z23;30;30;40;45Z");
    setTextColor(GREEN);
    printString("\x1b[Z24;50;50;75;155Z");
    setTextColor(CYAN);
    printString("\x1b[Z25;100;100;55Z");
    setTextColor(YELLOW);
    printString("\x1b[Z26;200;200;55Z");
    setTxtCursor(0, 20);
    setTextColor2(WHITE, BLACK);
    writeChar('a');
    enableCurs(true);
